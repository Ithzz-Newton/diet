...
function afterSubmit(e) {
  ...
  var url =
    "https://script.google.com/macros/s/AKfycbxt3S_B5TYo5r3jes2SFpHMx1RqrOA7vyXTAHONMcOgDLIz0pTfaqer2yFfLWgNnWk-3w/exec";
  ...
  fetch(url, {
    ...
    .then((res) => {
      console.log(res);
      window.location = "https://liff.line.me/1656999418-926ykYQX";
      registerForm.reset();
